<div class="content-wrapper-pdfview border pt-3 col-lg-12 shadow p-3 mb-5 bg-white rounded"   id="htmlview">
    ...
    <table style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif; margin-bottom: 20px;">
        <tr>
            ...
            <td style="width: 50%; text-align: right; vertical-align: top; font-size: 13px; line-height: 1.5; color: #000;">
                <table style="float: right; border-collapse: collapse;">
                    <tr>
                        <td style="text-align: right; padding:0;"><strong>Invoice Number:</strong></td>
                        <td style="text-align: left; padding: 0 0 0 10px; font-size: 13px; line-height: 1.5;"><?php if(!empty($formData['invoice_no'])) echo $formData['invoice_no']?></td>
                    </tr>
                    <tr>
                        <td style="text-align: right; padding:0;"><strong>Invoice Date:</strong></td>
                        <td id="previewInvoiceDate" style="text-align: left; padding: 0 0 0 10px; font-size: 13px; line-height: 1.5;"><?php if(!empty($formData['invoicedate'])) echo $formData['invoicedate'];?></td>
                    </tr>
                    <tr>
                        <td style="text-align: right; padding:0;"><strong>Terms:</strong></td>
                        <td id="previewInvoiceTerms" style="text-align: left; padding: 0 0 0 10px; font-size: 13px; line-height: 1.5;"><?php if(!empty($formData['terms'])) echo $formData['terms'];?></td>
                    </tr>
                    <tr>
                        <td style="text-align: right; padding:0;"><strong>Payment Due:</strong></td>
                        <td id="previewInvoiceDueDate" style="text-align: left; padding: 0 0 0 10px; font-size: 13px; line-height: 1.5;"><?php if(!empty($formData['duedate'])) echo $formData['duedate'];?></td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <table style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif; font-size: 13px;">
        ...
        <tr style="color: #333; line-height: 1.8;">
            <td colspan="2"></td>
    ...
    <table style="width: 100%; margin-top: 35px; font-size: 12px; font-family: Arial, sans-serif; color: #333">
        ...
        <tr>
            <td>
                <?php echo isset($formData['payment_instruction']) ? nl2br($formData['payment_instruction']) : ''; ?>
            </td>
        </tr>
    </table>   
</div>