...
<head>
    ...
    <title>Invoice System - New estimate</title>
    <?php include 'css.php' ?>
    <style>
    table {
        width: 100%;
...
<body id="page-top"> <!-- Page Wrapper -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content"><!-- Main Content -->
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4 p-3">
                    <h1 class="h3 mb-0 text-gray-800">New Estimate</h1>
                </div>
                ...
                <div id="createform">
                    <!-- <div>
                         <a href="#" class="btn btn-dark p-2 m-3 mr-5" id="btnsave"
                        ...
                        <div class="row container-fluid">
                            <div class="col-lg-8 col-sm-12 col-md-12" style="box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.5);">
                                <div class="card-header m-3"
                                    ...
                                    <!-- style="color:#1a1a1a; background-color: #d7d7cb; border-radius: 0 12px 12px 0;"> -->
                                ...
                                <div class="card-body">
                                    <div class="row" id="fetch_client">
                                        <input type="hidden" name="estimate_no" id="estimate_no" value="<?=$estimate_no?>" />
                                        ...
                                        <div class="oddRow" id="row0">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3" style="padding: 0;">
                                                    ...
                                                    id="costprice" placeholder="0"  oninput="updateNetPrice(this.value, this.id)"
                                                    style=" border-right: none; border-left: none; border-top: none;">
                                                </div>
                                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="commentdiv" style="display: block;">
                                        <div class="form-group row">
                                            <textarea class="form-control comment mt-3" name="comment" id="comment" cols="40"
                                                rows="4"  placeholder="Enter Comment"><?= !empty($invoices) ? $invoices[0]->comment : (!empty($comments) ? $comments[0]->comment : ''); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-12 col-md-12">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <span class="font-weight-bold"><?php if(!empty($company)) echo $estimate_no?></span>
                                </div>
                        ...
                        <div id="preview" style="display: none;">
                            <div class="container-fluid" style="padding-right: 0;">
                                ...
                                <div class="border bg-white row py-3" style="width: 100%;">
                                    <div class="col-lg-8">
                                        <span class="estimatePreviewpdF" style="width: 100%;"><?php include 'estimatepdfview.php' ?></span>
                                        <?php include 'estimatepdf.php' ?>
                                    </div>
                        ...
                        <div id="sendinvoice" style="display: none;">
                            <div class="container-fluid">
                                <div class="border bg-white row py-3 pl-3  ">
                                    <div class="content-wrapper pt-3 border col-lg-8" style="background-color: white;">
                                        <div class="send-header">
                                            ...
                                            <div class="email-form-row ">
                                                ...
                                                <input type="text" id="InvoiceSubject" name="InvoiceSubject" class="subject-input"
                                                    value="Estimate <?php echo $estimate_no; ?> from <?php echo $company->company_name ?? 'Unknown Company'; ?>" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <!-- <div class="mt-2 text-center">
                                            <p class="mb-0"> Already paid this invoice? </p>
                                            <a href="#">Click here</a> to notify me.
                                        </div> -->
                                        ...
                                        <div class="uploaded-attachment" id="uploaded-attachment">
                                                ...
                                                <div class="attached-docs">
                                                    <p class=" mt-1 mb-0" id="pdfFileName">EST001.pdf</p>
                                    ...
                                    <div class="content-wrapper-right col-lg-4 p-4" style="background-color: white; border-radius: 10px;">
                                        ...
                                        <div class="amount-display d-flex flex-row">
                                            <p><strong>Total</strong></p>
                                            <p class="ml-auto" id="sendSectionTotal">Ksh0.00</p>
                                        </div>
                                    <hr>
                                    <div class="col-sm-12 p-0">
                                        <href="#" class="btn btn-block p-1 mt-5 send-estimate-btn" id="send-estimate-btn" 
                                            style="text-decoration: none; background-color: #071a26; color: #fff;">
                                            <span class="fa fa-save fa-fw mr-2"></span>
    ...
    $(document).ready(function() {
        ...
        $("#pdfToggle input[type='checkbox']").on("change", function() {
            if ($(this).is(":checked")) {
                ...
                var loderImage = "/assets/img/ajax-loader_2.gif"
                ...
                $.ajax({
                            ...
                            <div class="row justify-content-center" style="width: 100%; height: 400px; display: flex; align-items: center;">
                                <div class="col-md-8">
                                    <div id="pdfLoader" style="text-align: center; padding: 20px; display: flex; align-items: center; justify-content: center; flex-direction: column; gap: 1rem;">
                                        <img src=${loderImage} alt="Loading..." />
                    ...
                    success: function(response) {
                        ...
                        $("#pdfview").html('<iframe src="' + pdfUrl + '" width="100%" height="600px"></iframe>').show();
                    },
                    error: function(xhr, status, error) {
                        console.error("AJAX Error:", status, error);
                        console.log("Response Text:", xhr.responseText);
                        $("#pdfview").html('<p style="display: flex; align-items: center; justify-content: center;">Error generating PDF. Please add an item and try again.</p>').show();
                    }
                });
            } else {
                $("#htmlview").show();
        ...
        $("#SaveNewClient").click(function(e){
            ...
            $.ajax({
                ...
                beforeSend: function () {
                    ...
                    "' style='margin-top:1%;;margin-left:30%' /> <br> <div style='margin-top:6%;margin-left:30%'><h1> Saving Client Please Wait.</h1></div>"
                    );
    ...
    $(document).ready(function() {
        $("#btnpreview").on("click", function(e) { 
            e.preventDefault();
        e.stopImmediatePropagation();
        var dataURLpay = '/preview-at-create-new-estimate';
        ...
        // console.log(dataToSend);
         ...
         $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    $('.estimatePreviewpdF').html(response.html);
                } else {
            ...
            //  capture value to populate the leftmost side of the page
            var total = $("#total").val();

            // right handside values
           // Update the Total
            var totalValue = total !== '' ? total : "0.00";
            $('#previewRightTotal').text("Ksh" + totalValue);
    ...
    $("#btnsend").on("click", function(e) { 
        ...
        $("#sendSectionTotal").text(`Ksh${sendSectionTotalValue}`);
        ...
        // var Bal = $("#balance").val().split("Ksh")[1];
        // var Total = $("#total").val().split("Ksh")[1];
    ...
    $(document).on("click", "#btnsave", function(e) {
        ...
        var Total = $("#total").val().includes('Ksh') ? $("#total").val().split('Ksh')[1] : $("#total").val();
        ...
        $.ajax({
            ...
            beforeSend: function() {
                $emptyDueDate   = $("#duedate").filter(function() {
                    return this.value === "";
                });

                $emptyName      = $("#autouser").filter(function() {
                    return this.value === "";
                });

                $emptyMobile    = $("#mobile").filter(function() {
                    return this.value === "";
                });

                $emptyEmail     = $("#useremail").filter(function() {
                    return this.value === "";
                });

                // $emptyAddress   = $("#bill_to").filter(function() {
                //     return this.value === "";
                // });
                
                if($emptyDueDate.length) { 
                ...
                if($emptyMobile.length) {
                    alert("Mobile Number Required!");
                    // window.location.reload();
                }
                if($emptyEmail.length) {
                ...
                if($emptyDueDate.length || $emptyName.length || $emptyMobile.length || $emptyEmail.length) {
                ...
                $(".modal-body").html("<img src='" + image +
                    "' style='margin-top:1%;;margin-left:50%' /> <br> <div style='margin-top:6%;;margin-left:30%'><i class='fa fa-save fa-3x'> </i> <h1> Saving estimate please wait.</h1></div>"
                );
        ...
        function initAutocomplete(selector) {
            $(selector).autocomplete({
                ...
                select: function(event, ui) {
                    ...
                    parent.find('.totalprice').val(total_price);
                ...
                '<div class="form-group row">'+
                    ...
                    '<div class="col-sm-3" style="padding: 0;">'+
                        '<label for="cost_price' + i + '" class="col-sm-12 col-form-label pl-0" style="color:#777;">Cost Price</label>'+
                            ...
                            i + '" placeholder="0" oninput="updateNetPrice(this.value, this.id)">'+
                    '</div>'+
                '</div>'+
    ...
    // $("#profit").val('Ksh' + profitLoss.toFixed(2));
    // }
    function calculateProfitLoss() {
    var total = parseFloat($("#total").val().replace('Ksh', ''));
    var netPrice = parseFloat($("#netprice").val());
   ...
   $("#itemname").autocomplete({
    ...
    // Save item to db if not 
     ...
     $(document).on('click', '.saveNewItemAtInvoiceCreation', function(e) {
            ...
            if (!itemDescription || !rate || !cost) {
                alert("Please make sure Item Description, Rate and Cost Price fields are filled out.");
                return;
            }
   ...
   $(document).on('click', '.cancelSaveButton', function() {
    ...
    //     var valueprice = 0;
    //     var valuesplit = '';
    //     var rate = $("#price" + i).val().replace('Ksh', '');
    ...
    //         // if (valueprice.includes('Ksh') == 'true') {
    //         let pricehere = parseInt(0);
    //         // console.log('pricehere',pricehere);
    //         if (valueprice == 0) {
    ...
    //     //  new values
    //     // let newsubtotal = $("#subtotal").val().split("Ksh")[1];
    //     // let newvalueprice = $("#" + id).val();
    //     // console.log(newvalueprice);
    //     // let final = + +totalprice + +newsubtotal;
    //     // console.log("newvalueprice", totalprice);
    //     // console.log("newsubtotal", newsubtotal);
    //     $("#subtotal").val(subtotal);
    //     $("#total").val('Ksh' + ((subtotal) - discount));
    //     $("#balance").val('Ksh' + ((subtotal - paid) - discount));
    //     $('#profitDisplay').val(total - netprice).replace('Ksh', ''); //new
    // }
    ...
    //receive data nfrom the invoice list
    $(document).ready(function() {
      ...
      $(document).ready(function() {
            ...
            const $sendInvoiceBtn = $('#send-estimate-btn');
            ...
            function showLoadingModal() {
                const loadingContent = `
                    ...
                    <div style="margin-top:6%; text-align: center">
                        <h1>Saving and sending mail, please wait...</h1>
                    </div>`;
            ...
            function handleSuccess(response) {
                ...
                $previewModal.modal('hide');
                $(".modal-body").html(
                    "<div style='margin-top:6%;;margin-left:30%'><h1> Mail sent successfully.</h1></div>"
                );
                $("#previewmodal").modal("show");
