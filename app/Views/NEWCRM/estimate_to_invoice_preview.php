...
<table style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif;">
        <tr>
            ...
            <td style="width: 50%; text-align: right; padding-top: 10px; vertical-align: top;">
                ...
                <p style="margin: 0; font-size: 13px; line-height: 1.5; color: #333;">
                    <span style="font-weight: bold;"><?= !empty($company->company_name) ? $company->company_name : 'Dreamline Holidays' ?></span><br>
    ...
    <table style="width: 100%; border-collapse: collapse; font-size: 13px; font-family: Arial, sans-serif;">
        ...
        <?php if (!empty($itemlist)) : ?>
            ...
            <?php foreach ($itemlist as $index => $item): ?>
                <tr style="color: #333;<?= $index === $lastIndex ? 'border-bottom: 1px solid #737373;' : 'border-bottom: 1px solid #333;' ?>">
                    ...
                    <td style="text-align: right; border-bottom: 1px solid #ddd;">
                        £<?= htmlspecialchars(number_format($item->totalprice, 2, '.', ',')) ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        <?php endif; ?>
        <tr style="color: #333;">
            ...
            <!-- <td style="text-align: right; padding-top: 12px;"><?php echo '£' . (!empty($estimate->subtotal) ? $estimate->subtotal : 0.00); ?></td> -->
            <td style="text-align: right;">
                <?php 
                    $total = isset($estimate->subtotal) ? $estimate->subtotal : 0.00;
        ...
        <tr style="color: #333;">
            ...
            <td style="text-align: right;">
                <?php 
                    $total = isset($estimate->discount) ? $estimate->discount : 0.00;
                    echo '£' . number_format($total, 2, '.', ',');
                ?>
            </td>
        </tr>
