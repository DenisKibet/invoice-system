...
<ul class="navbar-nav  sidebar sidebar-dark accordion"  style ="background-color: #0374da;" id="accordionSidebar">
  ...
  <li class="nav-item active">
    ...
    <li class="nav-item active">
        ...
        <div id="collapseSettings" class="collapse show" aria-labelledby="headingSettings" data-parent="#accordionSidebar" style="margin: 0;border-radius:0;background: #fff;">
            <div class="bg-white py-2 collapse-inner rounded">
    ...
    <li class="nav-item active" id="estimate" style="border-left: 4px solid red; padding-left: calc(1rem - 2px);">
