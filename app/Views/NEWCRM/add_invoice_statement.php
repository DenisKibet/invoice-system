...
<body id="page-top">
                    ...
                    <div class="card-body" style="width: 100%; background-color: #ffffff;">
                        ...
                        <div class="col-12 card-header" style="color:#1a1a1a; background-color: #f2efe8; border-radius: 0 12px 12px 0;">
                            <h4> <i class="fa fa-pen" style="color:#1a1a1a;vertical-align:middle;"></i>
                                Set Up Default Invoice Accompanying Text.</h4>
                        ...
                        <form id="commentform">
                            <div id="commentdiv" style="display: block; width: 100%;">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control mt-3" name="comment" id="comment" 
                                        placeholder="Enter a default statment that will be sent to the client along side the invoice pdf" 
                                        cols="20" rows="10"><?= (!empty($commenttext) ? $commenttext : ''); ?></textarea>
                                </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title"> SaTechs Invoice System!</h5>
    ...
    <script>
        ...
        $(document).on("click", "#btnsave", function (e) { 
            ...
            var dataURLpay = '/save-invoice-statement';
            ...
            $.ajax({
                ...
                beforeSend: function () {
                    $(".modal-body").html("<img src='" + image +
                        "' style='margin-top:1%;margin-left:50%' /> <br> <div style='margin-top:6%; text-align: center;'><h1> Saving statement, please wait...</h1></div>"                    );
                    $("#previewmodal").modal("show");
                },
                success: function (response) {
                    console.log(response);
                    $(".modal-body").html("<br> <div style='margin-top:6%; text-align: center;'><h1> Statement updated successfully.</h1></div>"                    );
                    $("#previewmodal").modal("show");
