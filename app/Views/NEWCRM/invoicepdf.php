<div class="pdfview pt-2 col-lg-12 mb-5 bg-white rounded" id="pdfview" style="height:100%; padding: 0;">
    ...
    <table style="width: 100%; padding-bottom: 20px; border-collapse: collapse; font-family: Arial, sans-serif; margin-bottom: 20px;">
        <tr>
