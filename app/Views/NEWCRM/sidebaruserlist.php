...
<ul class="navbar-nav  sidebar sidebar-dark accordion"  style ="background-color: #0374da;" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar" style="margin: 0;border-radius:0;background: #fff;">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header" style="color:#2489b5;"><b>Users</b></h6>
                <a class="collapse-item" href="/clientList"><i class="fa fa-address-book" aria-hidden="true"></i> Client Profiles</a>
                <a class="collapse-item" href="/stafflist"><i class="fa fa-archive" aria-hidden="true"></i> Staff List</a>
            </div>
        </div>
    </li>
