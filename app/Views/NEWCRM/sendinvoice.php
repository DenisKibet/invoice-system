<div class="content-wrapper-pdfview border pt-3 col-lg-8 shadow p-3 bg-white rounded" id="previewPdfview" >
        ...
        <tr>
            <td style="width: 50%; vertical-align: top;">
                ...
                <table style="line-height: 1.2; font-size: 13px;">
                    <tr>
                        <td>
                            <span style="font-weight: 500;"><?php if(!empty($clientname)) echo $clientname?></span>
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <td style="width: 50%; text-align: right; vertical-align: top; font-size: 13px; line-height: 1.5;">
                <table style="float: right; border-collapse: collapse;">
                    <tr>
                        ...
                        <td style="text-align: left; padding: 0 0 0 10px; font-size: 14px; line-height: 1.5;"><?php echo $invoice_no?></td>
                    </tr>
                    <tr>
                        <td style="text-align: right; padding: 0;"><strong>Invoice Date:</strong></td>
                        <td style="text-align: left; padding: 0 0 0 10px; font-size: 14px; line-height: 1.5;"><?php if(!empty($invoice_date)) echo $invoice_date;?></td>
                    </tr>
                    <tr>
                        <td style="text-align: right; padding: 0;"><strong>Terms:</strong></td>
                        <td style="text-align: left; padding: 0 0 0 10px; font-size: 14px; line-height: 1.5;"><?php if(!empty($invoice_term)) echo $invoice_term;?></td>
                    </tr>
                    <tr>
                        <td style="text-align: right; padding: 0;"><strong>Payment Due:</strong></td>
                        <td style="text-align: left; padding: 0 0 0 10px; font-size: 14px; line-height: 1.5;"><?php if(!empty($due_date)) echo $due_date;?></td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <table style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif; font-size: 13px;">
        ...
        <tr style="color: #333;">
            ...
            <td style="text-align: right;">
                <?php 
                    $paid = isset($paid) && is_numeric($paid) ? $paid : 0.00;
        ...
        <tr>
            ...
            <td style="text-align: right;"><strong>
                <?php 
                    $balance = isset($balance) && is_numeric($balance) ? $balance : 0.00;
    ...
    <table style="width: 100%; margin-top: 35px; font-size: 12px; font-family: Arial, sans-serif;">
        ...
        <tr style="color: #333;">
            <td>
                <?php echo isset($payments_instruction) ? nl2br($payments_instruction) : ''; ?>
            </td>
        </tr>
    </table>
</div>
